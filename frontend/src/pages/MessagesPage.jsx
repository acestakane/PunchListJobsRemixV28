...
export default function MessagesPage() {
  ...
  const isFree = !isAdmin && ["free", "expired", null, undefined].includes(user?.subscription_status);
            ...
            <div className={`${showList ? "flex" : "hidden"} md:flex flex-col w-full md:w-80 border-r border-slate-200 dark:border-slate-800 flex-shrink-0`}>
              <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
                ...
                <button
                  ...
                  title="Close"
                  data-testid="messages-close-btn"
                >
              ...
              {isAdmin && <p className="text-xs text-slate-400 px-4 pb-2">Support + job conversations</p>}
