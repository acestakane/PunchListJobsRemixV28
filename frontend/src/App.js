...
import JobsItinerary from "./pages/JobsItinerary";
...
function DashboardRedirect() {
  ...
  if (["admin", "superadmin", "subadmin"].includes(user.role)) return <Navigate to="/admin/dashboard" replace />;
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/archive" element={<ProtectedRoute roles={["contractor","admin","superadmin","crew"]}><ArchivePage /></ProtectedRoute>} />
